...
3. Hires-to-quits ratio (lower = deteriorating)
4. Temp help employment momentum
...
**Components:**
1. Quits rate (voluntary separations)
2. Job-to-job transition rate
...
**Note:** LDI appears in MRI with NEGATIVE sign (MRI = LFI - LDI + ...)
...
| **LDI** | Declining | Lower = worse | 🔴 | Worker caution |
